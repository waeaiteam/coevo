          ...
          <div key={i} className="card">
            ...
            <div className="text-xs space-y-0.5 mt-2" style={{color:"var(--text-muted)"}}>
              ...
              <div className="flex gap-2 mt-2 flex-wrap items-center">
                <button onClick={()=>act(()=>executeWorkOrder(o.work_order_id as string, o.track==="red"?{}:{}),"Execute")} disabled={o.track==="red"} className="px-2 py-1 text-xs rounded border" style={{borderColor:o.track==="red"?"var(--red)":"var(--accent)",color:o.track==="red"?"var(--red)":"var(--accent)",opacity:o.track==="red"?0.5:1}}>Execute{o.track==="red"?" (Blocked)":""}</button>
