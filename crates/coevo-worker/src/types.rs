...
pub struct AgentWorker {
    ...
    pub current_work_order_id: Option<String>,
    pub current_session_id: Option<String>,
    pub loaded_skills_json: serde_json::Value,
    pub memory_scope: String,
    pub tool_scope_json: serde_json::Value,
...
pub struct WorkerSession {
    ...
    pub context_memory_ids_json: serde_json::Value,
    pub loaded_skill_ids_json: serde_json::Value,
    pub tool_call_ids_json: serde_json::Value,
...
pub struct WorkerRun {
    ...
    pub memory_ids_json: serde_json::Value,
...
pub struct WorkerStep {
    ...
    pub run_id: String,
    pub step_index: i64,
    pub step_type: WorkerStepType,
    pub input_json: serde_json::Value,
    pub output_json: Option<serde_json::Value>,
    pub status: WorkerStepStatus,
    pub started_at_ms: i64,
    pub ended_at_ms: Option<i64>,
...
pub struct ReflectionRecord {
    ...
    pub agent_id: String,
    pub worker_id: String,
    pub what_worked_json: serde_json::Value,
    pub what_failed_json: serde_json::Value,
    pub memory_to_add_json: serde_json::Value,
    pub skill_to_update_json: serde_json::Value,
    pub user_preference_observed_json: serde_json::Value,
...
pub struct Tool {
    ...
    pub permission_boundary_json: serde_json::Value,
...
pub struct MemoryContext {
    ...
    pub excluded_revoked_count: usize,
    pub context_budget_chars: usize,
    pub fact_without_provenance: usize,
}

#[derive(Debug, Clone)]
pub struct TransitionContext {
    pub track: String,
    pub has_approval_receipt: bool,
    pub has_valid_lease: bool,
    pub reason: String,
}
