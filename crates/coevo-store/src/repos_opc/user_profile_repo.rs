...
impl UserProfileRepo {
    ...
    fn from_row(row: &sqlx::sqlite::SqliteRow) -> UserProfile {
        ...
        UserProfile {
            ...
            long_term_goals: serde_json::from_str(row.get("long_term_goals_json"))
                .unwrap_or_default(),
            business_domains: serde_json::from_str(row.get("business_domains_json"))
                .unwrap_or_default(),
            communication_style: row.get("communication_style"),
            approval_preferences: serde_json::from_str(row.get("approval_preferences_json"))
            ...
            data_boundaries: serde_json::from_str(row.get("data_boundaries_json"))
                .unwrap_or_default(),
            budget_limits: serde_json::from_str(row.get("budget_limits_json")).unwrap_or(
                BudgetLimits {
            ...
            favorite_tools: serde_json::from_str(row.get("favorite_tools_json"))
                .unwrap_or_default(),
